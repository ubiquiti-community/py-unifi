...
class SettingDoh(BaseModel):
    ...
    server_names: Optional[List[StrictStr]] = None
    site_id: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "key", "server_names", "site_id", "state"]
