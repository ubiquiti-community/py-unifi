...
class SettingPorta(BaseModel):
    ...
    ugw3_wan2_enabled: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "key", "site_id", "ugw3_wan2_enabled"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ugw3_wan2_enabled": obj.get("ugw3_wan2_enabled")
        })
        return _obj
