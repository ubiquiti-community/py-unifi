...
class SettingDpiResponse(BaseModel):
    """
    SettingDpiResponse
    """ # noqa: E501
    data: Optional[List[SettingDpi]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [SettingDpi.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
