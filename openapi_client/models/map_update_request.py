...
class MapUpdateRequest(BaseModel):
    ...
    map_type_id: Optional[StrictStr] = Field(default=None, alias="mapTypeId")
    name: Optional[StrictStr] = None
    offset_left: Optional[Union[StrictFloat, StrictInt]] = None
    offset_top: Optional[Union[StrictFloat, StrictInt]] = None
    opacity: Optional[Union[StrictFloat, StrictInt]] = None
    selected: Optional[StrictBool] = None
    site_id: Optional[StrictStr] = None
    tilt: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    upp: Optional[Union[StrictFloat, StrictInt]] = None
    zoom: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "lat", "lng", "mapTypeId", "name", "offset_left", "offset_top", "opacity", "selected", "site_id", "tilt", "type", "unit", "upp", "zoom"]
