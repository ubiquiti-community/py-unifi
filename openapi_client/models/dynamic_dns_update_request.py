...
class DynamicDNSUpdateRequest(BaseModel):
    """
    ...
    custom_service: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "custom_service", "host_name", "interface", "login", "options", "server", "service", "site_id", "x_password"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "custom_service": obj.get("custom_service"),
