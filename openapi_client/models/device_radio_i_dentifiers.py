...
class DeviceRadioIDentifiers(BaseModel):
    """
    DeviceRadioIDentifiers
    """ # noqa: E501
    device_id: Optional[StrictStr] = None
    radio_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["device_id", "radio_name"]
