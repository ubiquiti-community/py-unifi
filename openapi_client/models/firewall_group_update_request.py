...
class FirewallGroupUpdateRequest(BaseModel):
    """
    ...
    group_members: Optional[List[StrictStr]] = None
    group_type: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "group_members", "group_type", "name", "site_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "group_members": obj.get("group_members"),
