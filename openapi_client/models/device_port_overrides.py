...
class DevicePortOverrides(BaseModel):
    """
    DevicePortOverrides
    """ # noqa: E501
    aggregate_num_ports: Optional[StrictInt] = None
    ...
    portconf_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["aggregate_num_ports", "autoneg", "dot1x_ctrl", "dot1x_idle_timeout", "egress_rate_limit_kbps", "egress_rate_limit_kbps_enabled", "excluded_networkconf_ids", "forward", "full_duplex", "isolation", "lldpmed_enabled", "lldpmed_notify_enabled", "mirror_port_idx", "name", "native_networkconf_id", "op_mode", "poe_mode", "port_idx", "port_keepalive_enabled", "port_security_enabled", "port_security_mac_address", "portconf_id", "priority_queue1_level", "priority_queue2_level", "priority_queue3_level", "priority_queue4_level", "setting_preference", "speed", "stormctrl_bcast_enabled", "stormctrl_bcast_level", "stormctrl_bcast_rate", "stormctrl_mcast_enabled", "stormctrl_mcast_level", "stormctrl_mcast_rate", "stormctrl_type", "stormctrl_ucast_enabled", "stormctrl_ucast_level", "stormctrl_ucast_rate", "stp_port_mode", "tagged_vlan_mgmt", "voice_networkconf_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "aggregate_num_ports": obj.get("aggregate_num_ports"),
            ...
            "mirror_port_idx": obj.get("mirror_port_idx"),
            "name": obj.get("name"),
            ...
            "portconf_id": obj.get("portconf_id"),
