...
class SettingSuperMailResponse(BaseModel):
    """
    SettingSuperMailResponse
    """ # noqa: E501
    data: Optional[List[SettingSuperMail]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [SettingSuperMail.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
