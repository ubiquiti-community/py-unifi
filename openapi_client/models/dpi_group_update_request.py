...
class DpiGroupUpdateRequest(BaseModel):
    """
    ...
    dpiapp_ids: Optional[List[StrictStr]] = None
    enabled: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "dpiapp_ids", "enabled", "name", "site_id"]
