...
class Hotspot2ConfResponse(BaseModel):
    """
    Hotspot2ConfResponse
    """ # noqa: E501
    data: Optional[List[Hotspot2Conf]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [Hotspot2Conf.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
