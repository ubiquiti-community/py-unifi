...
class SettingDpi(BaseModel):
    ...
    fingerprinting_enabled: Optional[StrictBool] = Field(default=None, alias="fingerprintingEnabled")
    key: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "enabled", "fingerprintingEnabled", "key", "site_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "fingerprintingEnabled": obj.get("fingerprintingEnabled"),
            "key": obj.get("key"),
