...
class SettingSuperFwupdate(BaseModel):
    """
    ...
    controller_channel: Optional[StrictStr] = None
    firmware_channel: Optional[StrictStr] = None
    key: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    sso_enabled: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "controller_channel", "firmware_channel", "key", "site_id", "sso_enabled"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "controller_channel": obj.get("controller_channel"),
            "firmware_channel": obj.get("firmware_channel"),
            "key": obj.get("key"),
