...
class SettingNtp(BaseModel):
    ...
    ntp_server_1: Optional[StrictStr] = None
    ntp_server_2: Optional[StrictStr] = None
    ntp_server_3: Optional[StrictStr] = None
    ntp_server_4: Optional[StrictStr] = None
    setting_preference: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "key", "ntp_server_1", "ntp_server_2", "ntp_server_3", "ntp_server_4", "setting_preference", "site_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "key": obj.get("key"),
            "ntp_server_1": obj.get("ntp_server_1"),
            "ntp_server_2": obj.get("ntp_server_2"),
            "ntp_server_3": obj.get("ntp_server_3"),
            "ntp_server_4": obj.get("ntp_server_4"),
