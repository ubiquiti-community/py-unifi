...
class SettingEtherLightingResponse(BaseModel):
    """
    SettingEtherLightingResponse
    """ # noqa: E501
    data: Optional[List[SettingEtherLighting]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [SettingEtherLighting.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
