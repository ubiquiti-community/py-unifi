...
class NetworkNATOutboundIPAddresses(BaseModel):
    """
    NetworkNATOutboundIPAddresses
    """ # noqa: E501
    ip_address: Optional[StrictStr] = None
    wan_network_group: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ip_address", "wan_network_group"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "wan_network_group": obj.get("wan_network_group")
        })
        return _obj
