...
class DeviceApi:
    ...
    @validate_call
    async def list_device_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def list_device_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def update_device(
        self,
        id: StrictStr,
        device_update_request: Optional[DeviceUpdateRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    @validate_call
    async def update_device_with_http_info(
        self,
        id: StrictStr,
        device_update_request: Optional[DeviceUpdateRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    async def update_device_without_preload_content(
        self,
        id: StrictStr,
        device_update_request: Optional[DeviceUpdateRequest] = None,
        _request_timeout: Union[
