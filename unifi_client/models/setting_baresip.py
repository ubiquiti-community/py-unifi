...
class SettingBaresip(BaseModel):
    """
    SettingBaresip
    """ # noqa: E501
    ...
    outbound_proxy: Optional[StrictStr] = None
    package_url: Optional[StrictStr] = None
    server: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "enabled", "key", "outbound_proxy", "package_url", "server", "site_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "key": obj.get("key"),
            "outbound_proxy": obj.get("outbound_proxy"),
