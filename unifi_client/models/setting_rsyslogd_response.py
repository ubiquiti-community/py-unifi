...
class SettingRsyslogdResponse(BaseModel):
    """
    SettingRsyslogdResponse
    """ # noqa: E501
    data: Optional[List[SettingRsyslogd]] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [SettingRsyslogd.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
