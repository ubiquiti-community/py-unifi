...
class DashboardUpdateRequest(BaseModel):
    ...
    controller_version: Optional[StrictStr] = None
    desc: Optional[StrictStr] = None
    is_public: Optional[StrictBool] = None
    modules: Optional[List[DashboardModules]] = None
    name: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "controller_version", "desc", "is_public", "modules", "name", "site_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "modules": [DashboardModules.from_dict(_item) for _item in obj.get("modules")] if obj.get("modules") is not None else None,
            "name": obj.get("name"),
