...
class BroadcastGroupUpdateRequest(BaseModel):
    """
    ...
    member_table: Optional[List[StrictStr]] = None
    name: Optional[StrictStr] = None
    site_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "member_table", "name", "site_id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "member_table": obj.get("member_table"),
            "name": obj.get("name"),
