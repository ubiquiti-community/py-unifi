...
class SettingEtherLightingNetworkOverrides(BaseModel):
    """
    SettingEtherLightingNetworkOverrides
    """ # noqa: E501
    key: Optional[StrictStr] = None
    raw_color_hex: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["key", "raw_color_hex"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "key": obj.get("key"),
            "raw_color_hex": obj.get("raw_color_hex")
        })
        return _obj
