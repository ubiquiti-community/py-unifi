...
class ChannelPlanRadioTable(BaseModel):
    """
    ChannelPlanRadioTable
    """ # noqa: E501
    backup_channel: Optional[StrictStr] = None
    channel: Optional[StrictStr] = None
    device_mac: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    tx_power: Optional[StrictStr] = None
    tx_power_mode: Optional[StrictStr] = None
    width: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["backup_channel", "channel", "device_mac", "name", "tx_power", "tx_power_mode", "width"]
