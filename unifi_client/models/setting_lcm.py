...
class SettingLcm(BaseModel):
    ...
    brightness: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "brightness", "enabled", "idle_timeout", "key", "site_id", "sync", "touch_event"]
