...
class SettingTeleport(BaseModel):
    """
    SettingTeleport
    """ # noqa: E501
    ...
    subnet_cidr: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "enabled", "key", "site_id", "subnet_cidr"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "subnet_cidr": obj.get("subnet_cidr")
        })
        return _obj
