...
class SettingSuperEvents(BaseModel):
    """
    SettingSuperEvents
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    ignored: Optional[StrictStr] = Field(default=None, alias="_ignored")
    ...
    __properties: ClassVar[List[str]] = ["_id", "_ignored", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "key", "site_id"]
