...
class SettingAutoSpeedtest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["_id", "attr_hidden", "attr_hidden_id", "attr_no_delete", "attr_no_edit", "cron_expr", "enabled", "key", "site_id"]
