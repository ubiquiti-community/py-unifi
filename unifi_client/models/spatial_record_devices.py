...
class SpatialRecordDevices(BaseModel):
    """
    SpatialRecordDevices
    """ # noqa: E501
    mac: Optional[StrictStr] = None
    position: Optional[SpatialRecordPosition] = None
    __properties: ClassVar[List[str]] = ["mac", "position"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "mac": obj.get("mac"),
            "position": SpatialRecordPosition.from_dict(obj.get("position")) if obj.get("position") is not None else None
        })
        return _obj
