...
class TestSettingSuperCloudaccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingSuperCloudaccessResponse:
        """Test SettingSuperCloudaccessResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingSuperCloudaccessResponse`
        """
        model = SettingSuperCloudaccessResponse()
        if include_optional:
    ...
    def testSettingSuperCloudaccessResponse(self):
        """Test SettingSuperCloudaccessResponse"""
