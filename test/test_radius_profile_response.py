...
class TestRADIUSProfileResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RADIUSProfileResponse:
        """Test RADIUSProfileResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RADIUSProfileResponse`
        """
        model = RADIUSProfileResponse()
        if include_optional:
    ...
    def testRADIUSProfileResponse(self):
        """Test RADIUSProfileResponse"""
