...
class TestSettingGuestAccessResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingGuestAccessResponse:
        """Test SettingGuestAccessResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingGuestAccessResponse`
        """
        model = SettingGuestAccessResponse()
        if include_optional:
    ...
    def testSettingGuestAccessResponse(self):
        """Test SettingGuestAccessResponse"""
