...
class TestDHCPOptionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DHCPOptionResponse:
        """Test DHCPOptionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DHCPOptionResponse`
        """
        model = DHCPOptionResponse()
        if include_optional:
    ...
    def testDHCPOptionResponse(self):
        """Test DHCPOptionResponse"""
