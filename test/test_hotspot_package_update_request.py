...
class TestHotspotPackageUpdateRequest(unittest.TestCase):
    """HotspotPackageUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HotspotPackageUpdateRequest:
        """Test HotspotPackageUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotspotPackageUpdateRequest`
        """
        model = HotspotPackageUpdateRequest()
        if include_optional:
            return HotspotPackageUpdateRequest(
                id = '',
                amount = 1.337,
                attr_hidden = True,
                attr_hidden_id = '',
    ...
    def testHotspotPackageUpdateRequest(self):
        """Test HotspotPackageUpdateRequest"""
