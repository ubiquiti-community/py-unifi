...
class TestSettingLocaleResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingLocaleResponse:
        """Test SettingLocaleResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingLocaleResponse`
        """
        model = SettingLocaleResponse()
        if include_optional:
    ...
    def testSettingLocaleResponse(self):
        """Test SettingLocaleResponse"""
