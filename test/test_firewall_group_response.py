...
class TestFirewallGroupResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FirewallGroupResponse:
        """Test FirewallGroupResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FirewallGroupResponse`
        """
        model = FirewallGroupResponse()
        if include_optional:
    ...
    def testFirewallGroupResponse(self):
        """Test FirewallGroupResponse"""
