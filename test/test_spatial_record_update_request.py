...
class TestSpatialRecordUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpatialRecordUpdateRequest:
        """Test SpatialRecordUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpatialRecordUpdateRequest`
        """
        model = SpatialRecordUpdateRequest()
        if include_optional:
            return SpatialRecordUpdateRequest(
                id = '',
                attr_hidden = True,
                attr_hidden_id = '',
                attr_no_delete = True,
    ...
    def testSpatialRecordUpdateRequest(self):
        """Test SpatialRecordUpdateRequest"""
