...
class TestDpiGroupResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DpiGroupResponse:
        """Test DpiGroupResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DpiGroupResponse`
        """
        model = DpiGroupResponse()
        if include_optional:
