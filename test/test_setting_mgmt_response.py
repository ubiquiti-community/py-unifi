...
class TestSettingMgmtResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingMgmtResponse:
        """Test SettingMgmtResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingMgmtResponse`
        """
        model = SettingMgmtResponse()
        if include_optional:
    ...
    def testSettingMgmtResponse(self):
        """Test SettingMgmtResponse"""
