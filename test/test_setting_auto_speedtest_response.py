...
class TestSettingAutoSpeedtestResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingAutoSpeedtestResponse:
        """Test SettingAutoSpeedtestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingAutoSpeedtestResponse`
        """
        model = SettingAutoSpeedtestResponse()
        if include_optional:
    ...
    def testSettingAutoSpeedtestResponse(self):
        """Test SettingAutoSpeedtestResponse"""
