...
class TestHotspotOpResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HotspotOpResponse:
        """Test HotspotOpResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HotspotOpResponse`
        """
        model = HotspotOpResponse()
        if include_optional:
    ...
    def testHotspotOpResponse(self):
        """Test HotspotOpResponse"""
