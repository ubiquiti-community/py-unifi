...
class TestSettingSuperMgmt(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingSuperMgmt:
        """Test SettingSuperMgmt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingSuperMgmt`
        """
        model = SettingSuperMgmt()
        if include_optional:
            return SettingSuperMgmt(
                id = '',
