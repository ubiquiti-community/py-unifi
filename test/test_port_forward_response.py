...
class TestPortForwardResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PortForwardResponse:
        """Test PortForwardResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortForwardResponse`
        """
        model = PortForwardResponse()
        if include_optional:
    ...
    def testPortForwardResponse(self):
        """Test PortForwardResponse"""
