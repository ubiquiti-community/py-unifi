...
class TestSettingCountryResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingCountryResponse:
        """Test SettingCountryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingCountryResponse`
        """
        model = SettingCountryResponse()
        if include_optional:
    ...
    def testSettingCountryResponse(self):
        """Test SettingCountryResponse"""
