...
class TestSettingSnmpResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingSnmpResponse:
        """Test SettingSnmpResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingSnmpResponse`
        """
        model = SettingSnmpResponse()
        if include_optional:
    ...
    def testSettingSnmpResponse(self):
        """Test SettingSnmpResponse"""
