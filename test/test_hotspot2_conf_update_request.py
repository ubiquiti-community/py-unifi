...
class TestHotspot2ConfUpdateRequest(unittest.TestCase):
    """Hotspot2ConfUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Hotspot2ConfUpdateRequest:
        """Test Hotspot2ConfUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Hotspot2ConfUpdateRequest`
        """
        model = Hotspot2ConfUpdateRequest()
        if include_optional:
            return Hotspot2ConfUpdateRequest(
                id = '',
                anqp_domain_id = 56,
                attr_hidden = True,
                attr_hidden_id = '',
    ...
    def testHotspot2ConfUpdateRequest(self):
        """Test Hotspot2ConfUpdateRequest"""
