...
class TestSettingEtherLighting(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingEtherLighting:
        """Test SettingEtherLighting
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingEtherLighting`
        """
        model = SettingEtherLighting()
        if include_optional:
            return SettingEtherLighting(
                id = '',
                attr_hidden = True,
                attr_hidden_id = '',
                attr_no_delete = True,
    ...
    def testSettingEtherLighting(self):
        """Test SettingEtherLighting"""
