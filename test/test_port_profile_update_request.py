...
class TestPortProfileUpdateRequest(unittest.TestCase):
    """PortProfileUpdateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortProfileUpdateRequest:
        """Test PortProfileUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortProfileUpdateRequest`
        """
        model = PortProfileUpdateRequest()
        if include_optional:
            return PortProfileUpdateRequest(
                id = '',
                attr_hidden = True,
                attr_hidden_id = '',
                attr_no_delete = True,
    ...
    def testPortProfileUpdateRequest(self):
        """Test PortProfileUpdateRequest"""
