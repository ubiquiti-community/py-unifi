...
class TestChannelPlanUpdateRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ChannelPlanUpdateRequest:
        """Test ChannelPlanUpdateRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChannelPlanUpdateRequest`
        """
        model = ChannelPlanUpdateRequest()
        if include_optional:
    ...
    def testChannelPlanUpdateRequest(self):
        """Test ChannelPlanUpdateRequest"""
