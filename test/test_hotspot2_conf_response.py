...
class TestHotspot2ConfResponse(unittest.TestCase):
    """Hotspot2ConfResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Hotspot2ConfResponse:
        """Test Hotspot2ConfResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Hotspot2ConfResponse`
        """
        model = Hotspot2ConfResponse()
        if include_optional:
            return Hotspot2ConfResponse(
                data = [
                    openapi_client.models.hotspot2_conf.Hotspot2Conf(
                        _id = '', 
                        anqp_domain_id = 56, 
                        attr_hidden = True, 
                        attr_hidden_id = '', 
    ...
    def testHotspot2ConfResponse(self):
        """Test Hotspot2ConfResponse"""
