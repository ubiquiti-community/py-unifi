...
class TestSettingUsgResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SettingUsgResponse:
        """Test SettingUsgResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SettingUsgResponse`
        """
        model = SettingUsgResponse()
        if include_optional:
    ...
    def testSettingUsgResponse(self):
        """Test SettingUsgResponse"""
