...
------------- | ------------- | -------------
[**create_user**](UserApi.md#create_user) | **POST** /rest/user | 
[**delete_user**](UserApi.md#delete_user) | **DELETE** /rest/user/{id} | 
[**get_user**](UserApi.md#get_user) | **GET** /rest/user/{id} | 
[**list_user**](UserApi.md#list_user) | **GET** /rest/user | 
[**update_user**](UserApi.md#update_user) | **PUT** /rest/user/{id} | 


# **create_user**
> UserResponse create_user(user=user)
...
async with unifi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling UserApi->list_user: %s\n" % e)
```
...
# **update_user**
> UserResponse update_user(id, user_update_request=user_update_request)
...
------------- | ------------- | ------------- | -------------
 **id** | **str**|  | 
 **user_update_request** | [**UserUpdateRequest**](UserUpdateRequest.md)|  | [optional] 
