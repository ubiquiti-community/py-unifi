...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DHCPOptionApi(api_client)
    dhcp_option = openapi_client.DHCPOption() # DHCPOption |  (optional)

    try:
        api_response = api_instance.create_dhcp_option(dhcp_option=dhcp_option)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_dhcp_option(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_dhcp_option(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_dhcp_option()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DHCPOptionApi(api_client)
    id = 'id_example' # str | 
    dhcp_option_update_request = openapi_client.DHCPOptionUpdateRequest() # DHCPOptionUpdateRequest |  (optional)

    try:
        api_response = api_instance.update_dhcp_option(id, dhcp_option_update_request=dhcp_option_update_request)
