...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DpiGroupApi(api_client)
    dpi_group = openapi_client.DpiGroup() # DpiGroup |  (optional)

    try:
        api_response = api_instance.create_dpi_group(dpi_group=dpi_group)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.delete_dpi_group(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.get_dpi_group(id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_dpi_group()
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DpiGroupApi(api_client)
    id = 'id_example' # str | 
    dpi_group_update_request = openapi_client.DpiGroupUpdateRequest() # DpiGroupUpdateRequest |  (optional)

    try:
        api_response = api_instance.update_dpi_group(id, dpi_group_update_request=dpi_group_update_request)
